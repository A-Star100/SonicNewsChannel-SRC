...
public class XQResolveNames extends ResolveNames {
                    ...
                    if (name2.indexOf(58) < 0) {
                        ...
                        if (needFunction) {
                            ...
                            while (true) {
                                ...
                                if (i >= namespaceArr.length || (decl = this.lookup.lookup((Object) (sym2 = namespaceArr[i].getSymbol(name2)), namespace)) != null || (decl = flookup(sym2)) != null) {
                                    break;
                                }
                                i++;
                            }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:162:0x041d  */
    /* JADX WARNING: Removed duplicated region for block: B:176:0x043c  */
    /* JADX WARNING: Removed duplicated region for block: B:183:0x044e  */
    /* JADX WARNING: Removed duplicated region for block: B:187:0x0460  */
    ...
    public gnu.expr.Expression visitApplyExp(gnu.expr.ApplyExp r18, java.lang.Void r19) {
        ...
        L_0x0038:
            ...
            switch(r4) {
                case -36: goto L_0x0493;
                case -35: goto L_0x0493;
                case -34: goto L_0x03e8;
                case -33: goto L_0x03e8;
                case -32: goto L_0x03d3;
                case -31: goto L_0x03be;
                case -30: goto L_0x03a9;
        ...
        L_0x0460:
            ...
            gnu.xquery.lang.XQParser r2 = r1.parser     // Catch:{ RuntimeException -> 0x047d }
            gnu.xml.NamespaceBinding r2 = r2.constructorNamespaces     // Catch:{ RuntimeException -> 0x047d }
            gnu.xquery.lang.XQParser r3 = r1.parser     // Catch:{ RuntimeException -> 0x047d }
            gnu.xml.NamespaceBinding r3 = r3.prologNamespaces     // Catch:{ RuntimeException -> 0x047d }
            gnu.xquery.util.QNameUtils.resolveQName(r0, r2, r3)     // Catch:{ RuntimeException -> 0x047d }
            gnu.expr.QuoteExp r0 = gnu.xquery.lang.XQuery.trueExp     // Catch:{ RuntimeException -> 0x047d }
            return r0
        L_0x047d:
            r0 = move-exception
        ...
        L_0x04af:
            ...
            gnu.expr.QuoteExp r0 = (gnu.expr.QuoteExp) r0     // Catch:{ RuntimeException -> 0x04ca }
            java.lang.Object r0 = r0.getValue()     // Catch:{ RuntimeException -> 0x04ca }
            gnu.xquery.lang.XQParser r3 = r1.parser     // Catch:{ RuntimeException -> 0x04ca }
            gnu.xml.NamespaceBinding r3 = r3.prologNamespaces     // Catch:{ RuntimeException -> 0x04ca }
            java.lang.Object r0 = gnu.xquery.util.QNameUtils.resolveQName(r0, r2, r3)     // Catch:{ RuntimeException -> 0x04ca }
            gnu.expr.QuoteExp r2 = new gnu.expr.QuoteExp     // Catch:{ RuntimeException -> 0x04ca }
            r2.<init>(r0)     // Catch:{ RuntimeException -> 0x04ca }
            return r2
        L_0x04ca:
            r0 = move-exception
            gnu.expr.Compilation r2 = r17.getCompilation()
