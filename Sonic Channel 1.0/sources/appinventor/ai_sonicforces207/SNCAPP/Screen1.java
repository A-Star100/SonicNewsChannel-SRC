...
public class Screen1 extends Form implements Runnable {
    ...
    static final FString Lit16 = new FString("com.google.appinventor.components.runtime.WebViewer");
    static final SimpleSymbol Lit17 = ((SimpleSymbol) new SimpleSymbol("WebViewer1").readResolve());
    static final SimpleSymbol Lit18 = ((SimpleSymbol) new SimpleSymbol("HomeUrl").readResolve());
    static final FString Lit19 = new FString("com.google.appinventor.components.runtime.WebViewer");
    static final SimpleSymbol Lit2 = ((SimpleSymbol) new SimpleSymbol("*the-null-value*").readResolve());
    static final FString Lit20 = new FString("com.google.appinventor.components.runtime.Switch");
    static final SimpleSymbol Lit21 = ((SimpleSymbol) new SimpleSymbol("Switch1").readResolve());
    static final FString Lit22 = new FString("com.google.appinventor.components.runtime.Switch");
    static final SimpleSymbol Lit23 = ((SimpleSymbol) new SimpleSymbol("GoHome").readResolve());
    static final SimpleSymbol Lit24 = ((SimpleSymbol) new SimpleSymbol("Notifier1").readResolve());
    static final SimpleSymbol Lit25 = ((SimpleSymbol) new SimpleSymbol("LogWarning").readResolve());
    static final PairWithPosition Lit26;
    static final SimpleSymbol Lit27 = ((SimpleSymbol) new SimpleSymbol("Switch1$Changed").readResolve());
    static final SimpleSymbol Lit28 = ((SimpleSymbol) new SimpleSymbol("Changed").readResolve());
    static final FString Lit29 = new FString("com.google.appinventor.components.runtime.Notifier");
    static final SimpleSymbol Lit3 = ((SimpleSymbol) new SimpleSymbol("AboutScreen").readResolve());
    static final FString Lit30 = new FString("com.google.appinventor.components.runtime.Notifier");
    static final SimpleSymbol Lit31 = ((SimpleSymbol) new SimpleSymbol("get-simple-name").readResolve());
    static final SimpleSymbol Lit32 = ((SimpleSymbol) new SimpleSymbol("android-log-form").readResolve());
    static final SimpleSymbol Lit33 = ((SimpleSymbol) new SimpleSymbol("add-to-form-environment").readResolve());
    static final SimpleSymbol Lit34 = ((SimpleSymbol) new SimpleSymbol("lookup-in-form-environment").readResolve());
    static final SimpleSymbol Lit35 = ((SimpleSymbol) new SimpleSymbol("is-bound-in-form-environment").readResolve());
    static final SimpleSymbol Lit36 = ((SimpleSymbol) new SimpleSymbol("add-to-global-var-environment").readResolve());
    static final SimpleSymbol Lit37 = ((SimpleSymbol) new SimpleSymbol("add-to-events").readResolve());
    static final SimpleSymbol Lit38 = ((SimpleSymbol) new SimpleSymbol("add-to-components").readResolve());
    static final SimpleSymbol Lit39 = ((SimpleSymbol) new SimpleSymbol("add-to-global-vars").readResolve());
    static final SimpleSymbol Lit4;
    static final SimpleSymbol Lit40 = ((SimpleSymbol) new SimpleSymbol("add-to-form-do-after-creation").readResolve());
    static final SimpleSymbol Lit41 = ((SimpleSymbol) new SimpleSymbol("send-error").readResolve());
    static final SimpleSymbol Lit42 = ((SimpleSymbol) new SimpleSymbol("dispatchEvent").readResolve());
    static final SimpleSymbol Lit43 = ((SimpleSymbol) new SimpleSymbol("dispatchGenericEvent").readResolve());
    static final SimpleSymbol Lit44 = ((SimpleSymbol) new SimpleSymbol("lookup-handler").readResolve());
    ...
    static {
        ...
        Lit4 = simpleSymbol;
        Lit26 = PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1717612978156_0.9781410686655665-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 168152);
    }
    ...
    public Screen1() {
        ...
        frame2.$main = this;
        this.get$Mnsimple$Mnname = new ModuleMethod(frame2, 1, Lit31, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.onCreate = new ModuleMethod(frame2, 2, "onCreate", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.android$Mnlog$Mnform = new ModuleMethod(frame2, 3, Lit32, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnform$Mnenvironment = new ModuleMethod(frame2, 4, Lit33, 8194);
        this.lookup$Mnin$Mnform$Mnenvironment = new ModuleMethod(frame2, 5, Lit34, 8193);
        this.is$Mnbound$Mnin$Mnform$Mnenvironment = new ModuleMethod(frame2, 7, Lit35, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnglobal$Mnvar$Mnenvironment = new ModuleMethod(frame2, 8, Lit36, 8194);
        this.add$Mnto$Mnevents = new ModuleMethod(frame2, 9, Lit37, 8194);
        this.add$Mnto$Mncomponents = new ModuleMethod(frame2, 10, Lit38, 16388);
        this.add$Mnto$Mnglobal$Mnvars = new ModuleMethod(frame2, 11, Lit39, 8194);
        this.add$Mnto$Mnform$Mndo$Mnafter$Mncreation = new ModuleMethod(frame2, 12, Lit40, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.send$Mnerror = new ModuleMethod(frame2, 13, Lit41, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.process$Mnexception = new ModuleMethod(frame2, 14, "process-exception", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.dispatchEvent = new ModuleMethod(frame2, 15, Lit42, 16388);
        this.dispatchGenericEvent = new ModuleMethod(frame2, 16, Lit43, 16388);
        this.lookup$Mnhandler = new ModuleMethod(frame2, 17, Lit44, 8194);
        ...
        this.Switch1$Changed = new ModuleMethod(frame2, 27, Lit27, 0);
    }
        ...
        try {
            ...
            try {
                ...
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    ...
                    runtime.setAndCoerceProperty$Ex(simpleSymbol, simpleSymbol2, "SNC-Android", simpleSymbol3);
                    ...
                    Values.writeValues(runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit11, "Screen1", simpleSymbol3), $result);
                } else {
                ...
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    ...
                    addToComponents(simpleSymbol, Lit19, Lit17, lambda$Fn6);
                }
                this.Switch1 = null;
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit20, Lit21, lambda$Fn7), $result);
                } else {
                    addToComponents(simpleSymbol, Lit22, Lit21, lambda$Fn8);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    runtime.addToCurrentFormEnvironment(Lit27, this.Switch1$Changed);
                } else {
                    addToFormEnvironment(Lit27, this.Switch1$Changed);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                ...
                this.Notifier1 = null;
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit29, Lit24, Boolean.FALSE), $result);
                } else {
                    addToComponents(simpleSymbol, Lit30, Lit24, Boolean.FALSE);
                }
                runtime.initRuntime();
    ...
    static Object lambda3() {
        ...
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit9, Boolean.TRUE, simpleSymbol5);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit10, "Responsive", simpleSymbol3);
        return runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit11, "Screen1", simpleSymbol3);
    }

    static Object lambda4() {
        return runtime.setAndCoerceProperty$Ex(Lit13, Lit14, "Welcome to the Sonic Channel Android app! ", Lit4);
    }
    ...
    static Object lambda6() {
        return runtime.setAndCoerceProperty$Ex(Lit17, Lit18, "https://sites.google.com/view/snc-apk/home", Lit4);
    }
    ...
    static Object lambda8() {
        return runtime.setAndCoerceProperty$Ex(Lit21, Lit14, "To go to the site, turn this switch on", Lit4);
    }
    ...
    public Object Switch1$Changed() {
        runtime.setThisForm();
        runtime.callComponentMethod(Lit17, Lit23, LList.Empty, LList.Empty);
        return runtime.callComponentMethod(Lit24, Lit25, LList.list1("Android 5+ (2014 and onwards) is recommended. Otherwise you may get lag."), Lit26);
    }
