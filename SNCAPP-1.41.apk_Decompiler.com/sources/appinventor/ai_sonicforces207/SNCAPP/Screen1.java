...
public class Screen1 extends Form implements Runnable {
    ...
    static final SimpleSymbol Lit24 = ((SimpleSymbol) new SimpleSymbol("WebViewer1$BeforePageLoad").readResolve());
    static final SimpleSymbol Lit25 = ((SimpleSymbol) new SimpleSymbol("BeforePageLoad").readResolve());
    static final SimpleSymbol Lit26 = ((SimpleSymbol) new SimpleSymbol("TextToSpeech1").readResolve());
    static final SimpleSymbol Lit27 = ((SimpleSymbol) new SimpleSymbol("Speak").readResolve());
    static final PairWithPosition Lit28;
    static final SimpleSymbol Lit29 = ((SimpleSymbol) new SimpleSymbol("Notifier1").readResolve());
    static final SimpleSymbol Lit3 = ((SimpleSymbol) new SimpleSymbol("AboutScreen").readResolve());
    static final SimpleSymbol Lit30 = ((SimpleSymbol) new SimpleSymbol("ShowAlert").readResolve());
    ...
    static final SimpleSymbol Lit37 = ((SimpleSymbol) new SimpleSymbol("ClearCaches").readResolve());
    static final SimpleSymbol Lit38 = ((SimpleSymbol) new SimpleSymbol("ClearCookies").readResolve());
    static final SimpleSymbol Lit39 = ((SimpleSymbol) new SimpleSymbol("ClearLocations").readResolve());
    static final SimpleSymbol Lit4;
    static final SimpleSymbol Lit40 = ((SimpleSymbol) new SimpleSymbol("Button1$Click").readResolve());
    static final SimpleSymbol Lit41 = ((SimpleSymbol) new SimpleSymbol("Click").readResolve());
    static final FString Lit42 = new FString("com.google.appinventor.components.runtime.Switch");
    static final SimpleSymbol Lit43 = ((SimpleSymbol) new SimpleSymbol("Switch1").readResolve());
    static final FString Lit44 = new FString("com.google.appinventor.components.runtime.Switch");
    static final SimpleSymbol Lit45 = ((SimpleSymbol) new SimpleSymbol("On").readResolve());
    static final SimpleSymbol Lit46 = ((SimpleSymbol) new SimpleSymbol("GoHome").readResolve());
    static final SimpleSymbol Lit47 = ((SimpleSymbol) new SimpleSymbol("Switch1$Changed").readResolve());
    static final SimpleSymbol Lit48 = ((SimpleSymbol) new SimpleSymbol("Changed").readResolve());
    static final FString Lit49 = new FString("com.google.appinventor.components.runtime.Notifier");
    ...
    static final SimpleSymbol Lit52 = ((SimpleSymbol) new SimpleSymbol("number").readResolve());
    static final SimpleSymbol Lit53 = ((SimpleSymbol) new SimpleSymbol("TextColor").readResolve());
    static final IntNum Lit54;
    static final FString Lit55 = new FString("com.google.appinventor.components.runtime.Notifier");
    static final FString Lit56 = new FString("com.google.appinventor.components.runtime.TextToSpeech");
    static final FString Lit57 = new FString("com.google.appinventor.components.runtime.TextToSpeech");
    static final SimpleSymbol Lit58 = ((SimpleSymbol) new SimpleSymbol("get-simple-name").readResolve());
    static final SimpleSymbol Lit59 = ((SimpleSymbol) new SimpleSymbol("android-log-form").readResolve());
    static final SimpleSymbol Lit6 = ((SimpleSymbol) new SimpleSymbol(PropertyTypeConstants.PROPERTY_TYPE_BOOLEAN).readResolve());
    static final SimpleSymbol Lit60 = ((SimpleSymbol) new SimpleSymbol("add-to-form-environment").readResolve());
    static final SimpleSymbol Lit61 = ((SimpleSymbol) new SimpleSymbol("lookup-in-form-environment").readResolve());
    static final SimpleSymbol Lit62 = ((SimpleSymbol) new SimpleSymbol("is-bound-in-form-environment").readResolve());
    static final SimpleSymbol Lit63 = ((SimpleSymbol) new SimpleSymbol("add-to-global-var-environment").readResolve());
    static final SimpleSymbol Lit64 = ((SimpleSymbol) new SimpleSymbol("add-to-events").readResolve());
    static final SimpleSymbol Lit65 = ((SimpleSymbol) new SimpleSymbol("add-to-components").readResolve());
    static final SimpleSymbol Lit66 = ((SimpleSymbol) new SimpleSymbol("add-to-global-vars").readResolve());
    static final SimpleSymbol Lit67 = ((SimpleSymbol) new SimpleSymbol("add-to-form-do-after-creation").readResolve());
    static final SimpleSymbol Lit68 = ((SimpleSymbol) new SimpleSymbol("send-error").readResolve());
    static final SimpleSymbol Lit69 = ((SimpleSymbol) new SimpleSymbol("dispatchEvent").readResolve());
    static final SimpleSymbol Lit7 = ((SimpleSymbol) new SimpleSymbol("AppName").readResolve());
    static final SimpleSymbol Lit70 = ((SimpleSymbol) new SimpleSymbol("dispatchGenericEvent").readResolve());
    ...
    static {
        int[] iArr = new int[2];
        iArr[0] = -16777216;
        Lit54 = IntNum.make(iArr);
        SimpleSymbol simpleSymbol = (SimpleSymbol) new SimpleSymbol(PropertyTypeConstants.PROPERTY_TYPE_TEXT).readResolve();
        Lit4 = simpleSymbol;
        Lit31 = PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1718063190284_0.8058287244988543-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 164051);
        Lit28 = PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1718063190284_0.8058287244988543-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 163935);
    }
    ...
    public Screen1() {
        ...
        frame2.$main = this;
        this.get$Mnsimple$Mnname = new ModuleMethod(frame2, 1, Lit58, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.onCreate = new ModuleMethod(frame2, 2, "onCreate", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.android$Mnlog$Mnform = new ModuleMethod(frame2, 3, Lit59, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnform$Mnenvironment = new ModuleMethod(frame2, 4, Lit60, 8194);
        this.lookup$Mnin$Mnform$Mnenvironment = new ModuleMethod(frame2, 5, Lit61, 8193);
        this.is$Mnbound$Mnin$Mnform$Mnenvironment = new ModuleMethod(frame2, 7, Lit62, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnglobal$Mnvar$Mnenvironment = new ModuleMethod(frame2, 8, Lit63, 8194);
        this.add$Mnto$Mnevents = new ModuleMethod(frame2, 9, Lit64, 8194);
        this.add$Mnto$Mncomponents = new ModuleMethod(frame2, 10, Lit65, 16388);
        this.add$Mnto$Mnglobal$Mnvars = new ModuleMethod(frame2, 11, Lit66, 8194);
        this.add$Mnto$Mnform$Mndo$Mnafter$Mncreation = new ModuleMethod(frame2, 12, Lit67, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.send$Mnerror = new ModuleMethod(frame2, 13, Lit68, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.process$Mnexception = new ModuleMethod(frame2, 14, "process-exception", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.dispatchEvent = new ModuleMethod(frame2, 15, Lit69, 16388);
        this.dispatchGenericEvent = new ModuleMethod(frame2, 16, Lit70, 16388);
        this.lookup$Mnhandler = new ModuleMethod(frame2, 17, Lit71, 8194);
        ModuleMethod moduleMethod = new ModuleMethod(frame2, 18, (Object) null, 0);
        moduleMethod.setProperty("source-location", "/tmp/runtime6021597256529955821.scm:634");
        ...
        this.WebViewer1$BeforePageLoad = new ModuleMethod(frame2, 25, Lit24, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.WebViewer1$ErrorOccurred = new ModuleMethod(frame2, 26, Lit32, 12291);
        lambda$Fn7 = new ModuleMethod(frame2, 27, (Object) null, 0);
        lambda$Fn8 = new ModuleMethod(frame2, 28, (Object) null, 0);
        this.Button1$Click = new ModuleMethod(frame2, 29, Lit40, 0);
        lambda$Fn9 = new ModuleMethod(frame2, 30, (Object) null, 0);
        lambda$Fn10 = new ModuleMethod(frame2, 31, (Object) null, 0);
        this.Switch1$Changed = new ModuleMethod(frame2, 32, Lit47, 0);
    ...
    public final void run(CallContext $ctx) {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            Values.writeValues(runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit15, "1.4 (Blur)", simpleSymbol3), $result);
        } else {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            runtime.addToCurrentFormEnvironment(Lit24, this.WebViewer1$BeforePageLoad);
        } else {
            addToFormEnvironment(Lit24, this.WebViewer1$BeforePageLoad);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "WebViewer1", "BeforePageLoad");
        } else {
            addToEvents(Lit21, Lit25);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            runtime.addToCurrentFormEnvironment(Lit40, this.Button1$Click);
        } else {
            addToFormEnvironment(Lit40, this.Button1$Click);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "Button1", "Click");
        } else {
            addToEvents(Lit35, Lit41);
        }
        this.Switch1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit42, Lit43, lambda$Fn9), $result);
        } else {
            addToComponents(simpleSymbol, Lit44, Lit43, lambda$Fn10);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            runtime.addToCurrentFormEnvironment(Lit47, this.Switch1$Changed);
        } else {
            addToFormEnvironment(Lit47, this.Switch1$Changed);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "Switch1", "Changed");
        } else {
            addToEvents(Lit43, Lit48);
        }
        this.Notifier1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit49, Lit29, lambda$Fn11), $result);
        } else {
            addToComponents(simpleSymbol, Lit55, Lit29, lambda$Fn12);
        }
        this.TextToSpeech1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit56, Lit26, Boolean.FALSE), $result);
        } else {
            addToComponents(simpleSymbol, Lit57, Lit26, Boolean.FALSE);
        }
        runtime.initRuntime();
    }
    ...
    static Object lambda3() {
        ...
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit13, "Responsive", simpleSymbol3);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit14, "Sonic Channel - Android", simpleSymbol3);
        return runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit15, "1.4 (Blur)", simpleSymbol3);
    }
    ...
    static Object lambda6() {
        return runtime.setAndCoerceProperty$Ex(Lit21, Lit22, "https://sites.google.com/view/snc-mobile/home", Lit4);
    }
    ...
    public Object WebViewer1$ErrorOccurred(Object $errorCode, Object $description, Object $failingUrl) {
        ...
        runtime.setThisForm();
        runtime.callComponentMethod(Lit26, Lit27, LList.list1("An error has occured"), Lit28);
        runtime.callComponentMethod(Lit29, Lit30, LList.list1("Page could not load. Please reload app."), Lit31);
        return runtime.setAndCoerceProperty$Ex(Lit17, Lit18, "An error has occured", Lit4);
    }

    static Object lambda8() {
        return runtime.setAndCoerceProperty$Ex(Lit35, Lit18, "Clear All Data Stored", Lit4);
    }
    ...
    public Object Button1$Click() {
        ...
        runtime.callComponentMethod(simpleSymbol, Lit37, LList.Empty, LList.Empty);
        runtime.callComponentMethod(simpleSymbol, Lit38, LList.Empty, LList.Empty);
        return runtime.callComponentMethod(simpleSymbol, Lit39, LList.Empty, LList.Empty);
    }

    static Object lambda10() {
        return runtime.setAndCoerceProperty$Ex(Lit43, Lit18, "To go back to home, flick this switch.", Lit4);
    }
    ...
    public Object Switch1$Changed() {
        runtime.setThisForm();
        return runtime.get$Mnproperty.apply2(Lit43, Lit45) != Boolean.FALSE ? runtime.callComponentMethod(Lit21, Lit46, LList.Empty, LList.Empty) : Boolean.FALSE;
    }
    ...
    static Object lambda12() {
        ...
        IntNum intNum = Lit51;
        SimpleSymbol simpleSymbol3 = Lit52;
        runtime.setAndCoerceProperty$Ex(simpleSymbol, simpleSymbol2, intNum, simpleSymbol3);
        return runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit53, Lit54, simpleSymbol3);
    }
