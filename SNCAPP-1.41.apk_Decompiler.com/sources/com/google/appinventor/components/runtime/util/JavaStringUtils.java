...
public class JavaStringUtils {
        ...
        public void changeOrder(List<String> keys, String text) {
            Collections.sort(keys, new Comparator<String>() {
                public int compare(String s, String t1) {
                    return JavaStringUtils$MappingEarliestOccurrenceFirstOrder$1$$ExternalSyntheticBackport0.m(t1.length(), s.length());
                }
            });
        }
    }
        ...
        public void changeOrder(List<String> keys, String text) {
            ...
            Collections.sort(keys, new Comparator<String>() {
                public int compare(String s, String t1) {
                    ...
                    return JavaStringUtils$MappingEarliestOccurrenceFirstOrder$1$$ExternalSyntheticBackport0.m(id1, id2);
                }
            });
        }
    }
    ...
    private static class RangeComparator implements Comparator<Range> {
        ...
        public int compare(Range r1, Range r2) {
            ...
            return JavaStringUtils$MappingEarliestOccurrenceFirstOrder$1$$ExternalSyntheticBackport0.m(r2.end, r1.end);
        }
    }
