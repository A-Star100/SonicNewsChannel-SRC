...
public class XQParser extends Lexer {
    ...
    public Expression parseDataType() throws IOException, SyntaxException {
        ...
        } else if (this.curToken != OP_EMPTY_SEQUENCE) {
            return syntaxError("bad syntax - expected DataType");
        } else {
            parseSimpleKindType();
            int i2 = this.curToken;
            if (i2 == 63 || i2 == 413 || i2 == 415) {
                getRawToken();
    ...
    public Expression parseRelativePathExpr(Expression exp) throws IOException, SyntaxException {
        ...
        while (true) {
            ...
            Symbol symbol = DOT_VARNAME;
            Declaration dotDecl = lexp.addDeclaration((Object) symbol);
            ...
            if (descendants) {
                this.curToken = 47;
                lexp.body = new ApplyExp((Procedure) DescendantOrSelfAxis.anyNode, new ReferenceExp(symbol, dotDecl));
    ...
    public Expression parseStepExpr() throws IOException, SyntaxException {
        ...
        if (i == 46 || i == 51) {
            ...
            return parseStepQualifiers(exp, i2);
        }
            ...
            if (ch >= 0 && ch != 62) {
                ...
                if (definingNamespace != null) {
                    ...
                    while (true) {
                        ...
                        args[i7] = (Expression) vec.elementAt(vecSize + i7);
                    }
                    vec.setSize(vecSize);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:152:0x01f2 A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public gnu.expr.Expression parseMaybePrimaryExpr() throws java.io.IOException, gnu.text.SyntaxException {
        /*
            ...
            switch(r3) {
                ...
                case 48: goto L_0x02ff;
                case 49: goto L_0x02c2;
                case 50: goto L_0x02c2;
                case 70: goto L_0x026f;
                case 123: goto L_0x0264;
                case 197: goto L_0x01ac;
                case 249: goto L_0x01a3;
                case 250: goto L_0x01a3;
                case 251: goto L_0x007a;
                case 252: goto L_0x007a;
                case 253: goto L_0x007a;
                case 254: goto L_0x007a;
                case 255: goto L_0x007a;
                case 256: goto L_0x007a;
        ...
        L_0x02c2:
            ...
            java.math.BigDecimal r0 = new java.math.BigDecimal     // Catch:{ all -> 0x02e0 }
            r0.<init>(r2)     // Catch:{ all -> 0x02e0 }
            goto L_0x02da
        L_0x02d5:
            java.lang.Double r0 = new java.lang.Double     // Catch:{ all -> 0x02e0 }
            r0.<init>(r2)     // Catch:{ all -> 0x02e0 }
        L_0x02da:
            gnu.expr.QuoteExp r3 = new gnu.expr.QuoteExp     // Catch:{ all -> 0x02e0 }
            r3.<init>(r0)     // Catch:{ all -> 0x02e0 }
            goto L_0x033f
        L_0x02e0:
            r0 = move-exception
    ...
    public gnu.expr.Expression parse(gnu.expr.Compilation r18) throws java.io.IOException, gnu.text.SyntaxException {
        ...
        L_0x007c:
            ...
            r7 = 0
            switch(r0) {
                case 66: goto L_0x081d;
                case 69: goto L_0x0789;
                case 71: goto L_0x0738;
                case 72: goto L_0x06ef;
                case 73: goto L_0x0555;
                case 75: goto L_0x0523;
                case 76: goto L_0x04b1;
                case 77: goto L_0x03a0;
                case 78: goto L_0x03a0;
                case 79: goto L_0x0789;
                case 80: goto L_0x0378;
                case 83: goto L_0x0328;
                case 84: goto L_0x04a8;
                case 85: goto L_0x02f2;
        ...
        L_0x0656:
            ...
            r11.loadPackageInfo(r0)     // Catch:{ ClassNotFoundException -> 0x0685, all -> 0x0662 }
        L_0x0661:
            goto L_0x0687
        L_0x0662:
            r0 = move-exception
        ...
        L_0x0754:
            ...
            java.lang.String r3 = r1.resolveAgainstBaseUri(r3)     // Catch:{ Exception -> 0x0762 }
            gnu.xquery.util.NamedCollator r0 = gnu.xquery.util.NamedCollator.make(r3)     // Catch:{ Exception -> 0x0762 }
            r1.defaultCollator = r0     // Catch:{ Exception -> 0x0762 }
            goto L_0x0783
        L_0x0762:
            r0 = move-exception
