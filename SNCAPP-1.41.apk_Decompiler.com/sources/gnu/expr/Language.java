...
public abstract class Language {
    ...
    public static Language setSaveCurrent(Language language) {
        ...
        Language save = (Language) inheritableThreadLocal.get();
    ...
    public static void registerLanguage(String[] langMapping) {
        ...
        String[][] newLangs = new String[(strArr.length + 1)][];
        System.arraycopy(strArr, 0, newLangs, 0, strArr.length);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:17:0x002e A[SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:5:0x0014 A[ADDED_TO_REGION] */
    ...
    public static gnu.expr.Language getInstance(java.lang.String r8) {
        ...
        L_0x001e:
            r7 = r4[r5]     // Catch:{ ClassNotFoundException -> 0x002d }
            java.lang.Class r2 = java.lang.Class.forName(r7)     // Catch:{ ClassNotFoundException -> 0x002d }
            r3 = 0
            r3 = r4[r3]
            gnu.expr.Language r3 = getInstance(r3, r2)
            return r3
        L_0x002d:
            r7 = move-exception
        L_0x002e:
    ...
    public NamedLocation lookupBuiltin(Symbol name, Object property, int hash) {
        ...
        return environment.lookup(name, property, hash);
    }
