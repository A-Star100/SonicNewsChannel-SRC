...
public class Screen1 extends Form implements Runnable {
    ...
    static final SimpleSymbol Lit104 = ((SimpleSymbol) new SimpleSymbol("ShowTextDialog").readResolve());
    static final PairWithPosition Lit105;
    static final SimpleSymbol Lit106 = ((SimpleSymbol) new SimpleSymbol("Notifier1$AfterChoosing").readResolve());
    static final SimpleSymbol Lit107 = ((SimpleSymbol) new SimpleSymbol("AfterChoosing").readResolve());
    static final FString Lit108 = new FString("com.google.appinventor.components.runtime.TextToSpeech");
    static final FString Lit109 = new FString("com.google.appinventor.components.runtime.TextToSpeech");
    static final SimpleSymbol Lit11 = ((SimpleSymbol) new SimpleSymbol("OpenScreenAnimation").readResolve());
    static final FString Lit110 = new FString("com.google.appinventor.components.runtime.File");
    static final SimpleSymbol Lit111 = ((SimpleSymbol) new SimpleSymbol("DefaultScope").readResolve());
    static final SimpleSymbol Lit112 = ((SimpleSymbol) new SimpleSymbol("WritePermission").readResolve());
    static final FString Lit113 = new FString("com.google.appinventor.components.runtime.File");
    ...
    static final FString Lit48 = new FString("com.google.appinventor.components.runtime.WebViewer");
    static final SimpleSymbol Lit49 = ((SimpleSymbol) new SimpleSymbol("HomeUrl").readResolve());
    static final SimpleSymbol Lit5;
    static final FString Lit50 = new FString("com.google.appinventor.components.runtime.WebViewer");
    static final SimpleSymbol Lit51 = ((SimpleSymbol) new SimpleSymbol("CircularProgress1").readResolve());
    static final SimpleSymbol Lit52 = ((SimpleSymbol) new SimpleSymbol("Visible").readResolve());
    static final SimpleSymbol Lit53 = ((SimpleSymbol) new SimpleSymbol("WebViewer1$PageLoaded").readResolve());
    static final SimpleSymbol Lit54 = ((SimpleSymbol) new SimpleSymbol("PageLoaded").readResolve());
    static final SimpleSymbol Lit55 = ((SimpleSymbol) new SimpleSymbol("WebViewer1$BeforePageLoad").readResolve());
    static final SimpleSymbol Lit56 = ((SimpleSymbol) new SimpleSymbol("BeforePageLoad").readResolve());
    static final SimpleSymbol Lit57 = ((SimpleSymbol) new SimpleSymbol("TextToSpeech1").readResolve());
    static final SimpleSymbol Lit58 = ((SimpleSymbol) new SimpleSymbol("Speak").readResolve());
    ...
    static final SimpleSymbol Lit61 = ((SimpleSymbol) new SimpleSymbol("WebViewer1$ErrorOccurred").readResolve());
    static final SimpleSymbol Lit62 = ((SimpleSymbol) new SimpleSymbol("ErrorOccurred").readResolve());
    ...
    static final FString Lit67 = new FString("com.google.appinventor.components.runtime.CircularProgress");
    static final FString Lit68 = new FString("com.google.appinventor.components.runtime.CircularProgress");
    static final FString Lit69 = new FString("com.google.appinventor.components.runtime.Button");
    static final SimpleSymbol Lit7;
    static final SimpleSymbol Lit70 = ((SimpleSymbol) new SimpleSymbol("Button1").readResolve());
    static final FString Lit71 = new FString("com.google.appinventor.components.runtime.Button");
    static final SimpleSymbol Lit72 = ((SimpleSymbol) new SimpleSymbol("ClearCaches").readResolve());
    static final SimpleSymbol Lit73 = ((SimpleSymbol) new SimpleSymbol("ClearCookies").readResolve());
    static final SimpleSymbol Lit74 = ((SimpleSymbol) new SimpleSymbol("ClearLocations").readResolve());
    ...
    static final SimpleSymbol Lit77 = ((SimpleSymbol) new SimpleSymbol("Button4").readResolve());
    static final FString Lit78 = new FString("com.google.appinventor.components.runtime.Button");
    static final SimpleSymbol Lit79 = ((SimpleSymbol) new SimpleSymbol("File1").readResolve());
    static final SimpleSymbol Lit8 = ((SimpleSymbol) new SimpleSymbol("AppName").readResolve());
    static final SimpleSymbol Lit80 = ((SimpleSymbol) new SimpleSymbol("Scope").readResolve());
    static final SimpleSymbol Lit81;
    static final PairWithPosition Lit82;
    static final SimpleSymbol Lit83 = ((SimpleSymbol) new SimpleSymbol("Exists").readResolve());
    static final PairWithPosition Lit84;
    static final PairWithPosition Lit85;
    static final SimpleSymbol Lit86 = ((SimpleSymbol) new SimpleSymbol("SaveFile").readResolve());
    ...
    static final SimpleSymbol Lit91 = ((SimpleSymbol) new SimpleSymbol("ShowChooseDialog").readResolve());
    static final PairWithPosition Lit92;
    static final SimpleSymbol Lit93 = ((SimpleSymbol) new SimpleSymbol("Button4$Click").readResolve());
    ...
    static final SimpleSymbol Lit96 = ((SimpleSymbol) new SimpleSymbol("TextColor").readResolve());
    ...
    static {
        ...
        Lit7 = simpleSymbol3;
        Lit105 = PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol3, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 496264), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 496259), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 496253);
        Lit103 = PairWithPosition.make(simpleSymbol, PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 496113), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 496108);
        Lit102 = PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 496005), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 496000), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 495994);
        Lit101 = PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 495849), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 495843);
        Lit100 = PairWithPosition.make(simpleSymbol, PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 495715), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 495710);
        int[] iArr = new int[2];
        iArr[0] = -16777216;
        Lit97 = IntNum.make(iArr);
        Lit92 = PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol3, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 452251), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 452246), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 452241), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 452236), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 452230);
        Lit90 = PairWithPosition.make(simpleSymbol, PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 451980), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 451975);
        ...
        Lit81 = simpleSymbol4;
        Lit89 = PairWithPosition.make(simpleSymbol4, PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 451963), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 451907);
        Lit88 = PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 451651), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 451646), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 451640);
        Lit87 = PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 451432), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 451426);
        Lit85 = PairWithPosition.make(simpleSymbol, PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 451298), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 451293);
        Lit84 = PairWithPosition.make(simpleSymbol4, PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 451281), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 451225);
        Lit82 = PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 450978), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 450973), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 450967);
        Lit60 = PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 286965), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 286960), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 286954);
        Lit59 = PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 286815);
        Lit46 = PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 233797);
        Lit44 = PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 233674), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 233669), "/tmp/1719536929169_0.2990158413547467-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP_Notify_Last_Checkpoint/Screen1.yail", 233663);
    }
    ...
    public Screen1() {
        ...
        this.WebViewer1$PageLoaded = new ModuleMethod(frame2, 32, Lit53, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.WebViewer1$BeforePageLoad = new ModuleMethod(frame2, 33, Lit55, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.WebViewer1$ErrorOccurred = new ModuleMethod(frame2, 34, Lit61, 12291);
        ...
        this.Button1$Click = new ModuleMethod(frame2, 41, Lit75, 0);
        lambda$Fn18 = new ModuleMethod(frame2, 42, (Object) null, 0);
        lambda$Fn19 = new ModuleMethod(frame2, 43, (Object) null, 0);
        this.Button4$Click = new ModuleMethod(frame2, 44, Lit93, 0);
        lambda$Fn20 = new ModuleMethod(frame2, 45, (Object) null, 0);
        lambda$Fn21 = new ModuleMethod(frame2, 46, (Object) null, 0);
        this.Notifier1$AfterChoosing = new ModuleMethod(frame2, 47, Lit106, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
    ...
    public final void run(CallContext $ctx) {
        ...
        try {
            ...
            try {
                ...
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit48, Lit35, lambda$Fn10), $result);
                } else {
                    addToComponents(simpleSymbol, Lit50, Lit35, lambda$Fn11);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    runtime.addToCurrentFormEnvironment(Lit53, this.WebViewer1$PageLoaded);
                } else {
                    addToFormEnvironment(Lit53, this.WebViewer1$PageLoaded);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "WebViewer1", "PageLoaded");
                } else {
                    addToEvents(Lit35, Lit54);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    runtime.addToCurrentFormEnvironment(Lit55, this.WebViewer1$BeforePageLoad);
                } else {
                    addToFormEnvironment(Lit55, this.WebViewer1$BeforePageLoad);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "WebViewer1", "BeforePageLoad");
                } else {
                    addToEvents(Lit35, Lit56);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    runtime.addToCurrentFormEnvironment(Lit61, this.WebViewer1$ErrorOccurred);
                } else {
                    addToFormEnvironment(Lit61, this.WebViewer1$ErrorOccurred);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                ...
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit63, Lit64, lambda$Fn12), $result);
                } else {
                    addToComponents(simpleSymbol, Lit66, Lit64, lambda$Fn13);
                }
                this.CircularProgress1 = null;
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(runtime.addComponentWithinRepl(Lit64, Lit67, Lit51, lambda$Fn14), $result);
                } else {
                    addToComponents(Lit64, Lit68, Lit51, lambda$Fn15);
                }
                this.Button1 = null;
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(runtime.addComponentWithinRepl(Lit64, Lit69, Lit70, lambda$Fn16), $result);
                } else {
                    addToComponents(Lit64, Lit71, Lit70, lambda$Fn17);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    runtime.addToCurrentFormEnvironment(Lit75, this.Button1$Click);
                } else {
                ...
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    ...
                    addToEvents(Lit70, Lit38);
                }
                this.Button4 = null;
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(runtime.addComponentWithinRepl(Lit64, Lit76, Lit77, lambda$Fn18), $result);
                } else {
                    addToComponents(Lit64, Lit78, Lit77, lambda$Fn19);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    runtime.addToCurrentFormEnvironment(Lit93, this.Button4$Click);
                } else {
                    addToFormEnvironment(Lit93, this.Button4$Click);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                ...
                this.Notifier1 = null;
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit94, Lit42, lambda$Fn20), $result);
                } else {
                    addToComponents(simpleSymbol, Lit98, Lit42, lambda$Fn21);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    runtime.addToCurrentFormEnvironment(Lit106, this.Notifier1$AfterChoosing);
                } else {
                    addToFormEnvironment(Lit106, this.Notifier1$AfterChoosing);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "Notifier1", "AfterChoosing");
                } else {
                    addToEvents(Lit42, Lit107);
                }
                this.TextToSpeech1 = null;
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit108, Lit57, Boolean.FALSE), $result);
                } else {
                    addToComponents(simpleSymbol, Lit109, Lit57, Boolean.FALSE);
                }
                this.File1 = null;
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit110, Lit79, lambda$Fn22), $result);
                } else {
                    addToComponents(simpleSymbol, Lit113, Lit79, lambda$Fn23);
                }
                runtime.initRuntime();
    ...
    static Object lambda11() {
        return runtime.setAndCoerceProperty$Ex(Lit35, Lit49, "https://sites.google.com/view/snc-mobile/home", Lit5);
    }
    ...
    public Object WebViewer1$PageLoaded(Object $url) {
        ...
        runtime.setThisForm();
        return runtime.setAndCoerceProperty$Ex(Lit51, Lit52, Boolean.FALSE, Lit7);
    }

    public Object WebViewer1$BeforePageLoad(Object $url) {
        runtime.sanitizeComponentData($url);
        runtime.setThisForm();
        return runtime.setAndCoerceProperty$Ex(Lit51, Lit52, Boolean.TRUE, Lit7);
    }
    ...
    public Object WebViewer1$ErrorOccurred(Object $errorCode, Object $description, Object $failingUrl) {
        ...
        runtime.setThisForm();
        runtime.callComponentMethod(Lit57, Lit58, LList.list1("An error has occured"), Lit59);
        return runtime.callComponentMethod(Lit42, Lit43, LList.list3("Page could not load. Please reload app.", "Error", "OK"), Lit60);
    }
    ...
    static Object lambda13() {
        ...
        SimpleSymbol simpleSymbol3 = Lit18;
        runtime.setAndCoerceProperty$Ex(simpleSymbol, simpleSymbol2, intNum, simpleSymbol3);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit24, Lit65, simpleSymbol3);
        return runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit26, Lit27, simpleSymbol3);
    }
    ...
    static Object lambda17() {
        SimpleSymbol simpleSymbol = Lit70;
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit31, Lit32, Lit18);
    ...
    public Object Button1$Click() {
        ...
        runtime.callComponentMethod(simpleSymbol, Lit72, LList.Empty, LList.Empty);
        runtime.callComponentMethod(simpleSymbol, Lit73, LList.Empty, LList.Empty);
        return runtime.callComponentMethod(simpleSymbol, Lit74, LList.Empty, LList.Empty);
    }
    ...
    public Object Button4$Click() {
        ...
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit80, FileScope.Shared, Lit81);
        SimpleSymbol simpleSymbol2 = Lit42;
        SimpleSymbol simpleSymbol3 = Lit43;
        runtime.callComponentMethod(simpleSymbol2, simpleSymbol3, LList.list3("Before you attempt to save the HTML file, please ensure permissions for writing to external storage is enabled.", "Warning", "OK, I'll enable permissions"), Lit82);
        ModuleMethod moduleMethod = runtime.yail$Mnequal$Qu;
        SimpleSymbol simpleSymbol4 = Lit83;
        if (runtime.callYailPrimitive(moduleMethod, LList.list2(runtime.callComponentMethodWithBlockingContinuation(simpleSymbol, simpleSymbol4, LList.list2(FileScope.Shared, "/Download/snc.html"), Lit84), Boolean.FALSE), Lit85, "=") != Boolean.FALSE) {
            runtime.callComponentMethod(simpleSymbol, Lit86, LList.list2(runtime.lookupGlobalVarInCurrentFormEnvironment(Lit3, runtime.$Stthe$Mnnull$Mnvalue$St), "/Download/snc.html"), Lit87);
            return runtime.callComponentMethod(simpleSymbol2, simpleSymbol3, LList.list3("The HTML was created. Open this in your browser. This HTML does not refer to the entire page.", "File has been created", "OK"), Lit88);
        } else if (runtime.callYailPrimitive(runtime.yail$Mnequal$Qu, LList.list2(runtime.callComponentMethodWithBlockingContinuation(simpleSymbol, simpleSymbol4, LList.list2(FileScope.Shared, "/Download/snc.html"), Lit89), Boolean.TRUE), Lit90, "=") == Boolean.FALSE) {
            return Values.empty;
        } else {
            SimpleSymbol simpleSymbol5 = Lit91;
            ...
            return runtime.callComponentMethod(simpleSymbol2, simpleSymbol5, list1, Lit92);
        }
    }
    ...
    static Object lambda21() {
        ...
        SimpleSymbol simpleSymbol3 = Lit18;
        runtime.setAndCoerceProperty$Ex(simpleSymbol, simpleSymbol2, intNum, simpleSymbol3);
        return runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit96, Lit97, simpleSymbol3);
    }
    ...
    public Object Notifier1$AfterChoosing(Object $choice) {
        ...
        if ($choice2 instanceof Package) {
            obj = runtime.signalRuntimeError(strings.stringAppend("The variable ", runtime.getDisplayRepresentation(Lit99), " is not bound in the current context"), "Unbound Variable");
        } else {
            obj = $choice2;
        }
        if (runtime.callYailPrimitive(moduleMethod, LList.list2(obj, "Yes"), Lit100, "=") != Boolean.FALSE) {
            runtime.callComponentMethod(Lit79, Lit86, LList.list2(runtime.lookupGlobalVarInCurrentFormEnvironment(Lit3, runtime.$Stthe$Mnnull$Mnvalue$St), "/Download/snc.html"), Lit101);
            simpleSymbol = Lit42;
            simpleSymbol2 = Lit43;
            list3 = LList.list3("Open the HTML in your browser!", "File has been created", "OK");
            pairWithPosition = Lit102;
        } else {
            ModuleMethod moduleMethod2 = runtime.yail$Mnequal$Qu;
            if ($choice2 instanceof Package) {
                obj2 = runtime.signalRuntimeError(strings.stringAppend("The variable ", runtime.getDisplayRepresentation(Lit99), " is not bound in the current context"), "Unbound Variable");
            } else {
                obj2 = $choice2;
            }
            if (runtime.callYailPrimitive(moduleMethod2, LList.list2(obj2, "No"), Lit103, "=") == Boolean.FALSE) {
                return Values.empty;
            }
            simpleSymbol = Lit42;
            simpleSymbol2 = Lit104;
            list3 = LList.list3(":) Your choice = done!", "File Not Made :)", Boolean.TRUE);
            pairWithPosition = Lit105;
        }
    ...
    static Object lambda23() {
        SimpleSymbol simpleSymbol = Lit79;
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit111, "Shared", Lit81);
        return runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit112, Boolean.TRUE, Lit7);
    }
    ...
    public class frame extends ModuleBody {
        ...
        public Object apply3(ModuleMethod moduleMethod, Object obj, Object obj2, Object obj3) {
            return moduleMethod.selector == 34 ? this.$main.WebViewer1$ErrorOccurred(obj, obj2, obj3) : super.apply3(moduleMethod, obj, obj2, obj3);
        }
