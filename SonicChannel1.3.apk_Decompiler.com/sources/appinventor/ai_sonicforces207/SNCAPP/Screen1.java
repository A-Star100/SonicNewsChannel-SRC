...
public class Screen1 extends Form implements Runnable {
    ...
    static final SimpleSymbol Lit24 = ((SimpleSymbol) new SimpleSymbol("CurrentUrl").readResolve());
    ...
    static final SimpleSymbol Lit29 = ((SimpleSymbol) new SimpleSymbol("WebViewer1$PageLoaded").readResolve());
    static final SimpleSymbol Lit3 = ((SimpleSymbol) new SimpleSymbol("AboutScreen").readResolve());
    static final SimpleSymbol Lit30 = ((SimpleSymbol) new SimpleSymbol("PageLoaded").readResolve());
    static final SimpleSymbol Lit31 = ((SimpleSymbol) new SimpleSymbol("TextToSpeech1").readResolve());
    static final SimpleSymbol Lit32 = ((SimpleSymbol) new SimpleSymbol("Speak").readResolve());
    static final PairWithPosition Lit33;
    static final SimpleSymbol Lit34 = ((SimpleSymbol) new SimpleSymbol("Notifier1").readResolve());
    static final SimpleSymbol Lit35 = ((SimpleSymbol) new SimpleSymbol("ShowAlert").readResolve());
    static final PairWithPosition Lit36;
    static final SimpleSymbol Lit37 = ((SimpleSymbol) new SimpleSymbol("WebViewer1$ErrorOccurred").readResolve());
    static final SimpleSymbol Lit38 = ((SimpleSymbol) new SimpleSymbol("ErrorOccurred").readResolve());
    static final FString Lit39 = new FString("com.google.appinventor.components.runtime.Button");
    static final SimpleSymbol Lit4;
    static final SimpleSymbol Lit40 = ((SimpleSymbol) new SimpleSymbol("Button1").readResolve());
    static final FString Lit41 = new FString("com.google.appinventor.components.runtime.Button");
    static final SimpleSymbol Lit42 = ((SimpleSymbol) new SimpleSymbol("ClearCaches").readResolve());
    static final SimpleSymbol Lit43 = ((SimpleSymbol) new SimpleSymbol("ClearCookies").readResolve());
    static final SimpleSymbol Lit44 = ((SimpleSymbol) new SimpleSymbol("ClearLocations").readResolve());
    ...
    static final FString Lit47 = new FString("com.google.appinventor.components.runtime.Switch");
    static final SimpleSymbol Lit48 = ((SimpleSymbol) new SimpleSymbol("Switch1").readResolve());
    static final FString Lit49 = new FString("com.google.appinventor.components.runtime.Switch");
    static final SimpleSymbol Lit5 = ((SimpleSymbol) new SimpleSymbol("ActionBar").readResolve());
    static final SimpleSymbol Lit50 = ((SimpleSymbol) new SimpleSymbol("Enabled").readResolve());
    ...
    static {
        ...
        Lit4 = simpleSymbol2;
        Lit36 = PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1717697031969_0.6136778385494288-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 164051);
        Lit33 = PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1717697031969_0.6136778385494288-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 163935);
        Lit28 = PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1717697031969_0.6136778385494288-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 156269);
        Lit27 = PairWithPosition.make(simpleSymbol, PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1717697031969_0.6136778385494288-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 156123), "/tmp/1717697031969_0.6136778385494288-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 156118);
        Lit26 = PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1717697031969_0.6136778385494288-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 155955);
    ...
    public Screen1() {
        ...
        this.WebViewer1$PageLoaded = new ModuleMethod(frame2, 25, Lit29, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.WebViewer1$ErrorOccurred = new ModuleMethod(frame2, 26, Lit37, 12291);
        lambda$Fn7 = new ModuleMethod(frame2, 27, (Object) null, 0);
        lambda$Fn8 = new ModuleMethod(frame2, 28, (Object) null, 0);
        this.Button1$Click = new ModuleMethod(frame2, 29, Lit45, 0);
        lambda$Fn9 = new ModuleMethod(frame2, 30, (Object) null, 0);
        lambda$Fn10 = new ModuleMethod(frame2, 31, (Object) null, 0);
        this.Switch1$Changed = new ModuleMethod(frame2, 32, Lit52, 0);
    ...
    public final void run(CallContext $ctx) {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            runtime.addToCurrentFormEnvironment(Lit29, this.WebViewer1$PageLoaded);
        } else {
            addToFormEnvironment(Lit29, this.WebViewer1$PageLoaded);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "WebViewer1", "PageLoaded");
        } else {
            addToEvents(Lit21, Lit30);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            runtime.addToCurrentFormEnvironment(Lit37, this.WebViewer1$ErrorOccurred);
        } else {
            addToFormEnvironment(Lit37, this.WebViewer1$ErrorOccurred);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "WebViewer1", "ErrorOccurred");
        } else {
            addToEvents(Lit21, Lit38);
        }
        this.Button1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit39, Lit40, lambda$Fn7), $result);
        } else {
            addToComponents(simpleSymbol, Lit41, Lit40, lambda$Fn8);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            addToEvents(Lit48, Lit53);
        }
        this.Notifier1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit54, Lit34, lambda$Fn11), $result);
        } else {
            addToComponents(simpleSymbol, Lit60, Lit34, lambda$Fn12);
        }
        this.TextToSpeech1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit61, Lit31, Boolean.FALSE), $result);
        } else {
            addToComponents(simpleSymbol, Lit62, Lit31, Boolean.FALSE);
        }
        runtime.initRuntime();
    }
    ...
    public Object WebViewer1$PageLoaded(Object $url) {
        ...
        if (runtime.callYailPrimitive(moduleMethod, LList.list2(moduleMethod2.apply2(simpleSymbol, simpleSymbol2), "https://sonicrumble.sega.com/"), Lit25, "=") != Boolean.FALSE) {
            runtime.callYailPrimitive(runtime.close$Mnscreen$Mnwith$Mnplain$Mntext, LList.list1("Sorry, but you cannot access this site. Use your regular browser instead."), Lit26, "close screen with plain text");
        }
        return runtime.callYailPrimitive(runtime.yail$Mnequal$Qu, LList.list2(runtime.get$Mnproperty.apply2(simpleSymbol, simpleSymbol2), "http://sonicrumble.com"), Lit27, "=") != Boolean.FALSE ? runtime.callYailPrimitive(runtime.close$Mnscreen$Mnwith$Mnplain$Mntext, LList.list1("You may not access this site due to security reasons"), Lit28, "close screen with plain text") : Values.empty;
    }
    ...
    public Object WebViewer1$ErrorOccurred(Object $errorCode, Object $description, Object $failingUrl) {
        ...
        runtime.setThisForm();
        runtime.callComponentMethod(Lit31, Lit32, LList.list1("An error has occured"), Lit33);
        runtime.callComponentMethod(Lit34, Lit35, LList.list1("Page could not load. Please reload app."), Lit36);
        return runtime.setAndCoerceProperty$Ex(Lit17, Lit18, "An error has occured", Lit4);
    }

    static Object lambda8() {
        return runtime.setAndCoerceProperty$Ex(Lit40, Lit18, "Clear All Data Stored", Lit4);
    }
    ...
    public Object Button1$Click() {
        runtime.setThisForm();
        SimpleSymbol simpleSymbol = Lit21;
        runtime.callComponentMethod(simpleSymbol, Lit42, LList.Empty, LList.Empty);
        runtime.callComponentMethod(simpleSymbol, Lit43, LList.Empty, LList.Empty);
        return runtime.callComponentMethod(simpleSymbol, Lit44, LList.Empty, LList.Empty);
    }

    static Object lambda10() {
        return runtime.setAndCoerceProperty$Ex(Lit48, Lit18, "To go back to home, flick this switch.", Lit4);
    }
    ...
    public Object Switch1$Changed() {
        runtime.setThisForm();
        return runtime.get$Mnproperty.apply2(Lit48, Lit50) != Boolean.FALSE ? runtime.callComponentMethod(Lit21, Lit51, LList.Empty, LList.Empty) : Values.empty;
    }
