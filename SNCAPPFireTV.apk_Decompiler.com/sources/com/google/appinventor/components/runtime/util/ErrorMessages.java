...
public final class ErrorMessages {
    ...
    static {
        ...
        hashMap.put(315, "Invalid Path to Image; Update will not be sent.");
        ...
        hashMap.put(Integer.valueOf(ERROR_EV3_ILLEGAL_MOTOR_PORT), "Cannot understant motor port: %s");
        hashMap.put(Integer.valueOf(ERROR_EV3_ILLEGAL_SENSOR_PORT), "Cannot understant sensor port: %s");
        ...
        hashMap.put(Integer.valueOf(ERROR_ACTIONBAR_NOT_SUPPORTED), "ActionBar is not supported on this device.");
        ...
        hashMap.put(1103, "Unable to complete the given request with the text \"%s\" with the specified URL: %s");
        hashMap.put(1104, "Unable to complete the given request with the file \"%s\" with the specified URL %s.");
        ...
        hashMap.put(Integer.valueOf(ERROR_WEB_JSON_TEXT_ENCODE_FAILED), "Unable to encode as JSON the object %s");
        ...
        hashMap.put(Integer.valueOf(ERROR_INVALID_CONFIGURATION_VALUE), "Invalid value %1$d given for ARConfigurationType.  Valid settings are 1, 2, or 3.");
        ...
        hashMap.put(Integer.valueOf(ERROR_SERIAL_NOT_INITIALIZED), "Serial was not initialized");
        hashMap.put(Integer.valueOf(ERROR_SERIAL_WRITING), "Error writing data to serial");
        ...
        hashMap.put(Integer.valueOf(ERROR_INVALID_CHART_ENTRY_VALUES), "Invalid Chart Entry Value(s): %1$s, %2$s");
        hashMap.put(Integer.valueOf(ERROR_NULL_CHART_ENTRY_VALUES), "Undefined value was present in Chart Entry");
        hashMap.put(Integer.valueOf(ERROR_INSUFFICIENT_CHART_ENTRY_VALUES), "Chart entry did not contain enough values; Expected %1$d, but was %2$d");
        hashMap.put(Integer.valueOf(ERROR_INVALID_CHART_DATA_COLOR), "Invalid Chart Data color parameter specified: %1$s");
        hashMap.put(Integer.valueOf(ERROR_CHATBOT_ERROR), "Error from the ChatBot code %1$d %2$s");
        hashMap.put(Integer.valueOf(ERROR_IMAGEBOT_ERROR), "Error from the ImageBot code %1$d %2$s");
        hashMap.put(Integer.valueOf(ERROR_SPREADSHEET_ERROR), "Error in Spreadsheet: %1$s");
        hashMap.put(Integer.valueOf(ERROR_FILEPICKER_NO_URI_RETURNED), "No URI returned to FilePicker");
        hashMap.put(Integer.valueOf(ERROR_LISTVIEW_INDEX_OUT_OF_BOUNDS), "The index %d is out of bounds for the list view.");
    }
