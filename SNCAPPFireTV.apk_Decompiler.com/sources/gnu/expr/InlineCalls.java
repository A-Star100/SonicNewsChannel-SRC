...
public class InlineCalls extends ExpExpVisitor<Type> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x006e, code lost:
        if ((r2 instanceof gnu.mapping.Procedure) == false) goto L_0x007a;
     */
    ...
    public gnu.expr.Expression maybeInline(gnu.expr.ApplyExp r13, gnu.bytecode.Type r14, gnu.mapping.Procedure r15) {
        /*
            ...
            gnu.mapping.Symbol r2 = gnu.mapping.Procedure.validateApplyKey     // Catch:{ all -> 0x0089 }
            java.lang.Object r2 = r15.getProperty(r2, r1)     // Catch:{ all -> 0x0089 }
