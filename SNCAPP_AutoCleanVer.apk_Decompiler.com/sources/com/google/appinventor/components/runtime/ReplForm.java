...
public class ReplForm extends Form {
    ...
    public void loadComponents(List<String> extensionNames) {
        ...
        Set<String> extensions2 = new HashSet<>(extensionNames);
        int i = 0;
        ...
        File[] listFiles = componentFolder.listFiles();
        int length = listFiles.length;
        while (i < length) {
            File compFolder = listFiles[i];
            if (!compFolder.isDirectory()) {
                extensions = extensions2;
            } else if (!extensions2.contains(compFolder.getName())) {
                extensions = extensions2;
            } else {
                String path = compFolder.getPath();
                File component = new File(path + File.separator + "classes.jar");
                String path2 = compFolder.getPath();
                String str = File.separator;
                extensions = extensions2;
                File loadComponent = new File(path2 + str + compFolder.getName() + ".jar");
