...
public class Screen1 extends Form implements Runnable {
    ...
    static final SimpleSymbol Lit24 = ((SimpleSymbol) new SimpleSymbol("GoToUrl").readResolve());
    static final PairWithPosition Lit25;
    static final SimpleSymbol Lit26 = ((SimpleSymbol) new SimpleSymbol("WebViewer1$BeforePageLoad").readResolve());
    static final SimpleSymbol Lit27 = ((SimpleSymbol) new SimpleSymbol("BeforePageLoad").readResolve());
    static final SimpleSymbol Lit28 = ((SimpleSymbol) new SimpleSymbol("TextToSpeech1").readResolve());
    static final SimpleSymbol Lit29 = ((SimpleSymbol) new SimpleSymbol("Speak").readResolve());
    ...
    static final SimpleSymbol Lit32 = ((SimpleSymbol) new SimpleSymbol("ShowAlert").readResolve());
    static final PairWithPosition Lit33;
    static final SimpleSymbol Lit34 = ((SimpleSymbol) new SimpleSymbol("WebViewer1$ErrorOccurred").readResolve());
    static final SimpleSymbol Lit35 = ((SimpleSymbol) new SimpleSymbol("ErrorOccurred").readResolve());
    static final FString Lit36 = new FString("com.google.appinventor.components.runtime.Button");
    static final SimpleSymbol Lit37 = ((SimpleSymbol) new SimpleSymbol("Button1").readResolve());
    static final FString Lit38 = new FString("com.google.appinventor.components.runtime.Button");
    static final SimpleSymbol Lit39 = ((SimpleSymbol) new SimpleSymbol("ClearCaches").readResolve());
    static final SimpleSymbol Lit4;
    static final SimpleSymbol Lit40 = ((SimpleSymbol) new SimpleSymbol("ClearCookies").readResolve());
    static final SimpleSymbol Lit41 = ((SimpleSymbol) new SimpleSymbol("ClearLocations").readResolve());
    ...
    static final SimpleSymbol Lit45 = ((SimpleSymbol) new SimpleSymbol("Switch1").readResolve());
    static final FString Lit46 = new FString("com.google.appinventor.components.runtime.Switch");
    static final SimpleSymbol Lit47 = ((SimpleSymbol) new SimpleSymbol("On").readResolve());
    static final SimpleSymbol Lit48 = ((SimpleSymbol) new SimpleSymbol("GoHome").readResolve());
    static final SimpleSymbol Lit49 = ((SimpleSymbol) new SimpleSymbol("Switch1$Changed").readResolve());
    static final SimpleSymbol Lit5 = ((SimpleSymbol) new SimpleSymbol("ActionBar").readResolve());
    static final SimpleSymbol Lit50 = ((SimpleSymbol) new SimpleSymbol("Changed").readResolve());
    static final FString Lit51 = new FString("com.google.appinventor.components.runtime.Notifier");
    ...
    static final SimpleSymbol Lit54 = ((SimpleSymbol) new SimpleSymbol("number").readResolve());
    static final SimpleSymbol Lit55 = ((SimpleSymbol) new SimpleSymbol("TextColor").readResolve());
    static final IntNum Lit56;
    static final FString Lit57 = new FString("com.google.appinventor.components.runtime.Notifier");
    static final FString Lit58 = new FString("com.google.appinventor.components.runtime.TextToSpeech");
    static final FString Lit59 = new FString("com.google.appinventor.components.runtime.TextToSpeech");
    ...
    static {
        ...
        Lit4 = simpleSymbol;
        Lit33 = PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1718061760335_0.16041413082586364-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 164051);
        Lit30 = PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1718061760335_0.16041413082586364-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 163935);
        Lit25 = PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1718061760335_0.16041413082586364-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 155767);
    }
    ...
    public Screen1() {
        ...
        moduleMethod.setProperty("source-location", "/tmp/runtime8324199466240740473.scm:634");
        ...
        this.WebViewer1$BeforePageLoad = new ModuleMethod(frame2, 25, Lit26, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.WebViewer1$ErrorOccurred = new ModuleMethod(frame2, 26, Lit34, 12291);
        lambda$Fn7 = new ModuleMethod(frame2, 27, (Object) null, 0);
        lambda$Fn8 = new ModuleMethod(frame2, 28, (Object) null, 0);
        this.Button1$Click = new ModuleMethod(frame2, 29, Lit42, 0);
        lambda$Fn9 = new ModuleMethod(frame2, 30, (Object) null, 0);
        lambda$Fn10 = new ModuleMethod(frame2, 31, (Object) null, 0);
        this.Switch1$Changed = new ModuleMethod(frame2, 32, Lit49, 0);
    ...
    public final void run(CallContext $ctx) {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            runtime.addToCurrentFormEnvironment(Lit26, this.WebViewer1$BeforePageLoad);
        } else {
            addToFormEnvironment(Lit26, this.WebViewer1$BeforePageLoad);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "WebViewer1", "BeforePageLoad");
        } else {
            addToEvents(Lit21, Lit27);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            runtime.addToCurrentFormEnvironment(Lit34, this.WebViewer1$ErrorOccurred);
        } else {
            addToFormEnvironment(Lit34, this.WebViewer1$ErrorOccurred);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "WebViewer1", "ErrorOccurred");
        } else {
            addToEvents(Lit21, Lit35);
        }
        this.Button1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            addToEvents(Lit37, Lit43);
        }
        this.Switch1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit44, Lit45, lambda$Fn9), $result);
        } else {
            addToComponents(simpleSymbol, Lit46, Lit45, lambda$Fn10);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            runtime.addToCurrentFormEnvironment(Lit49, this.Switch1$Changed);
        } else {
            addToFormEnvironment(Lit49, this.Switch1$Changed);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "Switch1", "Changed");
        } else {
            addToEvents(Lit45, Lit50);
        }
        this.Notifier1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit51, Lit31, lambda$Fn11), $result);
        } else {
            addToComponents(simpleSymbol, Lit57, Lit31, lambda$Fn12);
        }
        this.TextToSpeech1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit58, Lit28, Boolean.FALSE), $result);
        } else {
            addToComponents(simpleSymbol, Lit59, Lit28, Boolean.FALSE);
        }
        runtime.initRuntime();
    }
    ...
    public Object WebViewer1$BeforePageLoad(Object $url) {
        ...
        runtime.setThisForm();
        return runtime.callComponentMethod(Lit21, Lit24, LList.list1("https://sites.google.com/view/snc-mobile/home"), Lit25);
    }
    ...
    public Object WebViewer1$ErrorOccurred(Object $errorCode, Object $description, Object $failingUrl) {
        ...
        runtime.setThisForm();
        runtime.callComponentMethod(Lit28, Lit29, LList.list1("An error has occured"), Lit30);
        runtime.callComponentMethod(Lit31, Lit32, LList.list1("Page could not load. Please reload app."), Lit33);
        return runtime.setAndCoerceProperty$Ex(Lit17, Lit18, "An error has occured", Lit4);
    }

    static Object lambda8() {
        return runtime.setAndCoerceProperty$Ex(Lit37, Lit18, "Clear All Data Stored", Lit4);
    }
    ...
    public Object Button1$Click() {
        ...
        runtime.callComponentMethod(simpleSymbol, Lit39, LList.Empty, LList.Empty);
        runtime.callComponentMethod(simpleSymbol, Lit40, LList.Empty, LList.Empty);
        return runtime.callComponentMethod(simpleSymbol, Lit41, LList.Empty, LList.Empty);
    }

    static Object lambda10() {
        return runtime.setAndCoerceProperty$Ex(Lit45, Lit18, "To go back to home, flick this switch.", Lit4);
    }
    ...
    public Object Switch1$Changed() {
        runtime.setThisForm();
        return runtime.get$Mnproperty.apply2(Lit45, Lit47) != Boolean.FALSE ? runtime.callComponentMethod(Lit21, Lit48, LList.Empty, LList.Empty) : Boolean.FALSE;
    }
    ...
    static Object lambda12() {
        ...
        return runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit55, Lit56, simpleSymbol3);
    }
