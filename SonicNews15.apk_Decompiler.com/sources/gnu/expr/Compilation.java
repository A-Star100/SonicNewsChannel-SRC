...
public class Compilation implements SourceLocator {
    ...
    static {
        ...
        makeListMethod = classType.addMethod("makeList", makeListArgs, (Type) classType, 9);
        ...
        apply0method = typeProcedure.addMethod("apply0", typeArr2, (Type) classType2, 17);
        ...
        applyCpsMethod = typeProcedure.addMethod("apply", typeArr3, (Type) Type.voidType, 1);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x007f, code lost:
        if (r2.max_args >= (r2.min_args + r0)) goto L_0x0084;
     */
    /* JADX WARNING: Removed duplicated region for block: B:107:0x0295 A[SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:108:0x01d4 A[EDGE_INSN: B:108:0x01d4->B:78:0x01d4 ?: BREAK  , SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:110:0x01c6 A[SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:111:0x0287 A[EDGE_INSN: B:111:0x0287->B:96:0x0287 ?: BREAK  , SYNTHETIC] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:61:0x0144 A[ADDED_TO_REGION] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:95:0x0283 A[LOOP:3: B:93:0x027e->B:95:0x0283, LOOP_END] */
    ...
    public void generateApplyMethodsWithContext(gnu.expr.LambdaExp r37) {
        ...
        L_0x002d:
            ...
            gnu.bytecode.Method r1 = r1.addMethod((java.lang.String) r3, (gnu.bytecode.Type[]) r14, (gnu.bytecode.Type) r2, (int) r13)
            r6.method = r1
    ...
    public void generateApplyMethodsWithoutContext(LambdaExp lexp) {
        ...
        if (numApplyMethods != 0) {
            ...
            ClassType heapFrameType = lexp.getHeapFrameType();
                ...
                while (j < numApplyMethods) {
                    ...
                    if (skipThisProc) {
                        ...
                        if (!needThisApply3) {
                            ...
                            save_method = save_method2;
                            Method addMethod = this.curClass.addMethod(mname2, applyArgs2, defaultCallConvention >= k ? Type.voidType : Type.objectType, 1);
                            this.method = addMethod;
                            CodeAttr code3 = addMethod.startCode();
                        ...
                        if (((int) needsThis) + ((int) explicitFrameArg) > 0) {
                            ...
                            if (classType == classType2 && this.mainClass != classType2) {
    ...
    public void generateBytecode() {
        ...
        Method apply_method = this.curClass.addMethod("run", arg_types, (Type) Type.voidType, 17);
        ...
        ClassType classType2 = neededSuper;
        if (this.curClass == this.mainClass) {
            ...
            if (staticModule) {
                ...
                ClassType classType3 = this.moduleClass;
                int i2 = line;
                int i3 = arg_count;
                Field addField = classType3.addField("$instance", classType3, 25);
            ...
            if (this.moduleClass == this.mainClass || staticModule || this.generateMain || this.immediate) {
                ...
                CodeAttr codeAttr = code2;
                Initializer initializer3 = init;
                Method addMethod = this.curClass.addMethod("run", 1, Type.typeArray0, (Type) Type.voidType);
                this.method = addMethod;
        ...
        if (!this.generateMain || this.curClass != this.mainClass) {
            CodeAttr codeAttr2 = code;
        } else {
            Method addMethod2 = this.curClass.addMethod("main", 9, new Type[]{new ArrayType(javaStringType)}, (Type) Type.voidType);
            ...
            if (field != null) {
                ...
                code4.emitDup((Type) this.curClass);
        ...
        if (moduleInfo != null) {
            ...
            if (namespaceUri != null) {
                ...
                CodeAttr codeAttr4 = code5;
                Method method3 = superConstructor;
                Method addMethod3 = mapClass.addMethod("register", new Type[]{typeModuleManager}, (Type) Type.voidType, 1);
                this.method = addMethod3;
                CodeAttr code6 = addMethod3.startCode();
                ClassType classType4 = mapClass;
                ...
                while (true) {
                    ...
                    if (i7 >= 0) {
                        ...
                        ClassType classType5 = typeModuleManager;
                        String str5 = uri2;
                        ModuleManager moduleManager3 = manager2;
                        ClassType classType6 = typeModuleSet2;
    ...
    public void loadClassRef(ObjectType clas) {
        ...
        } else if (clas != this.mainClass || !this.mainLambda.isStatic() || (field = this.moduleInstanceMainField) == null) {
