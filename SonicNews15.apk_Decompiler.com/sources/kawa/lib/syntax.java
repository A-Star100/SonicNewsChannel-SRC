...
public class syntax extends ModuleBody {
    ...
    public static final Macro f4import;
    ...
    static {
        ...
        SimpleSymbol simpleSymbol7 = (SimpleSymbol) new SimpleSymbol("x").readResolve();
        ...
        f5synchronized = Macro.make(simpleSymbol78, new ModuleMethod(syntax, 3, (Object) null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), syntax);
        ...
        f4import = Macro.make(simpleSymbol66, syntaxRules10, syntax);
