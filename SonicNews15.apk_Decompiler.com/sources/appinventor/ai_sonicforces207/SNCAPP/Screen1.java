...
public class Screen1 extends Form implements Runnable {
    ...
    static final IntNum Lit16 = IntNum.make(15);
    static final SimpleSymbol Lit17 = ((SimpleSymbol) new SimpleSymbol("number").readResolve());
    static final SimpleSymbol Lit18 = ((SimpleSymbol) new SimpleSymbol("VersionName").readResolve());
    ...
    static final SimpleSymbol Lit29 = ((SimpleSymbol) new SimpleSymbol("Button3").readResolve());
    ...
    static final SimpleSymbol Lit33 = ((SimpleSymbol) new SimpleSymbol("GoHome").readResolve());
    static final SimpleSymbol Lit34 = ((SimpleSymbol) new SimpleSymbol("Button3$Click").readResolve());
    ...
    static final SimpleSymbol Lit37 = ((SimpleSymbol) new SimpleSymbol("HomeUrl").readResolve());
    static final FString Lit38 = new FString("com.google.appinventor.components.runtime.WebViewer");
    static final SimpleSymbol Lit39 = ((SimpleSymbol) new SimpleSymbol("WebViewer1$BeforePageLoad").readResolve());
    static final SimpleSymbol Lit4;
    static final SimpleSymbol Lit40 = ((SimpleSymbol) new SimpleSymbol("BeforePageLoad").readResolve());
    ...
    static final SimpleSymbol Lit44 = ((SimpleSymbol) new SimpleSymbol("Notifier1").readResolve());
    static final SimpleSymbol Lit45 = ((SimpleSymbol) new SimpleSymbol("ShowAlert").readResolve());
    static final PairWithPosition Lit46;
    static final SimpleSymbol Lit47 = ((SimpleSymbol) new SimpleSymbol("WebViewer1$ErrorOccurred").readResolve());
    static final SimpleSymbol Lit48 = ((SimpleSymbol) new SimpleSymbol("ErrorOccurred").readResolve());
    ...
    static final SimpleSymbol Lit55 = ((SimpleSymbol) new SimpleSymbol("Button1").readResolve());
    static final FString Lit56 = new FString("com.google.appinventor.components.runtime.Button");
    static final SimpleSymbol Lit57 = ((SimpleSymbol) new SimpleSymbol("ClearCaches").readResolve());
    static final SimpleSymbol Lit58 = ((SimpleSymbol) new SimpleSymbol("ClearCookies").readResolve());
    static final SimpleSymbol Lit59 = ((SimpleSymbol) new SimpleSymbol("ClearLocations").readResolve());
    ...
    static final SimpleSymbol Lit62 = ((SimpleSymbol) new SimpleSymbol("Button2").readResolve());
    static final FString Lit63 = new FString("com.google.appinventor.components.runtime.Button");
    static final SimpleSymbol Lit64 = ((SimpleSymbol) new SimpleSymbol("GoToUrl").readResolve());
    static final PairWithPosition Lit65;
    static final SimpleSymbol Lit66 = ((SimpleSymbol) new SimpleSymbol("ShowTextDialog").readResolve());
    static final PairWithPosition Lit67;
    static final SimpleSymbol Lit68 = ((SimpleSymbol) new SimpleSymbol("Button2$Click").readResolve());
    static final FString Lit69 = new FString("com.google.appinventor.components.runtime.Notifier");
    ...
    static final FString Lit73 = new FString("com.google.appinventor.components.runtime.Notifier");
    static final FString Lit74 = new FString("com.google.appinventor.components.runtime.TextToSpeech");
    static final FString Lit75 = new FString("com.google.appinventor.components.runtime.TextToSpeech");
    static final FString Lit76 = new FString("com.google.appinventor.components.runtime.File");
    static final SimpleSymbol Lit77 = ((SimpleSymbol) new SimpleSymbol("File1").readResolve());
    static final FString Lit78 = new FString("com.google.appinventor.components.runtime.File");
    static final SimpleSymbol Lit79 = ((SimpleSymbol) new SimpleSymbol("get-simple-name").readResolve());
    static final SimpleSymbol Lit8 = ((SimpleSymbol) new SimpleSymbol("CloseScreenAnimation").readResolve());
    static final SimpleSymbol Lit80 = ((SimpleSymbol) new SimpleSymbol("android-log-form").readResolve());
    static final SimpleSymbol Lit81 = ((SimpleSymbol) new SimpleSymbol("add-to-form-environment").readResolve());
    static final SimpleSymbol Lit82 = ((SimpleSymbol) new SimpleSymbol("lookup-in-form-environment").readResolve());
    static final SimpleSymbol Lit83 = ((SimpleSymbol) new SimpleSymbol("is-bound-in-form-environment").readResolve());
    static final SimpleSymbol Lit84 = ((SimpleSymbol) new SimpleSymbol("add-to-global-var-environment").readResolve());
    static final SimpleSymbol Lit85 = ((SimpleSymbol) new SimpleSymbol("add-to-events").readResolve());
    static final SimpleSymbol Lit86 = ((SimpleSymbol) new SimpleSymbol("add-to-components").readResolve());
    static final SimpleSymbol Lit87 = ((SimpleSymbol) new SimpleSymbol("add-to-global-vars").readResolve());
    static final SimpleSymbol Lit88 = ((SimpleSymbol) new SimpleSymbol("add-to-form-do-after-creation").readResolve());
    static final SimpleSymbol Lit89 = ((SimpleSymbol) new SimpleSymbol("send-error").readResolve());
    static final SimpleSymbol Lit9 = ((SimpleSymbol) new SimpleSymbol("Icon").readResolve());
    static final SimpleSymbol Lit90 = ((SimpleSymbol) new SimpleSymbol("dispatchEvent").readResolve());
    static final SimpleSymbol Lit91 = ((SimpleSymbol) new SimpleSymbol("dispatchGenericEvent").readResolve());
    static final SimpleSymbol Lit92 = ((SimpleSymbol) new SimpleSymbol("lookup-handler").readResolve());
    ...
    static {
        ...
        Lit6 = simpleSymbol2;
        Lit67 = PairWithPosition.make(simpleSymbol, PairWithPosition.make(simpleSymbol, PairWithPosition.make(simpleSymbol2, LList.Empty, "/tmp/1718937040173_0.3678811893178444-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 340398), "/tmp/1718937040173_0.3678811893178444-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 340393), "/tmp/1718937040173_0.3678811893178444-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 340387);
        Lit65 = PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1718937040173_0.3678811893178444-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 340138);
        Lit46 = PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1718937040173_0.3678811893178444-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 221395);
        Lit43 = PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1718937040173_0.3678811893178444-0/youngandroidproject/../src/appinventor/ai_sonicforces207/SNCAPP/Screen1.yail", 221279);
    }
    ...
    public Screen1() {
        ...
        frame2.$main = this;
        this.get$Mnsimple$Mnname = new ModuleMethod(frame2, 1, Lit79, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.onCreate = new ModuleMethod(frame2, 2, "onCreate", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.android$Mnlog$Mnform = new ModuleMethod(frame2, 3, Lit80, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnform$Mnenvironment = new ModuleMethod(frame2, 4, Lit81, 8194);
        this.lookup$Mnin$Mnform$Mnenvironment = new ModuleMethod(frame2, 5, Lit82, 8193);
        this.is$Mnbound$Mnin$Mnform$Mnenvironment = new ModuleMethod(frame2, 7, Lit83, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnglobal$Mnvar$Mnenvironment = new ModuleMethod(frame2, 8, Lit84, 8194);
        this.add$Mnto$Mnevents = new ModuleMethod(frame2, 9, Lit85, 8194);
        this.add$Mnto$Mncomponents = new ModuleMethod(frame2, 10, Lit86, 16388);
        this.add$Mnto$Mnglobal$Mnvars = new ModuleMethod(frame2, 11, Lit87, 8194);
        this.add$Mnto$Mnform$Mndo$Mnafter$Mncreation = new ModuleMethod(frame2, 12, Lit88, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.send$Mnerror = new ModuleMethod(frame2, 13, Lit89, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.process$Mnexception = new ModuleMethod(frame2, 14, "process-exception", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.dispatchEvent = new ModuleMethod(frame2, 15, Lit90, 16388);
        this.dispatchGenericEvent = new ModuleMethod(frame2, 16, Lit91, 16388);
        this.lookup$Mnhandler = new ModuleMethod(frame2, 17, Lit92, 8194);
        ModuleMethod moduleMethod = new ModuleMethod(frame2, 18, (Object) null, 0);
        moduleMethod.setProperty("source-location", "/tmp/runtime16963093997196274805.scm:634");
        ...
        this.Button3$Click = new ModuleMethod(frame2, 25, Lit34, 0);
        lambda$Fn7 = new ModuleMethod(frame2, 26, (Object) null, 0);
        lambda$Fn8 = new ModuleMethod(frame2, 27, (Object) null, 0);
        this.WebViewer1$BeforePageLoad = new ModuleMethod(frame2, 28, Lit39, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.WebViewer1$ErrorOccurred = new ModuleMethod(frame2, 29, Lit47, 12291);
        ...
        this.Button1$Click = new ModuleMethod(frame2, 34, Lit60, 0);
        lambda$Fn13 = new ModuleMethod(frame2, 35, (Object) null, 0);
        lambda$Fn14 = new ModuleMethod(frame2, 36, (Object) null, 0);
        this.Button2$Click = new ModuleMethod(frame2, 37, Lit68, 0);
    ...
    public final void run(CallContext $ctx) {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit15, Lit16, Lit17);
            Values.writeValues(runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit18, "1.5 (Sky)", simpleSymbol3), $result);
        } else {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            addToComponents(simpleSymbol, Lit27, Lit20, lambda$Fn4);
        }
        this.Button3 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(Lit20, Lit28, Lit29, lambda$Fn5), $result);
        } else {
            addToComponents(Lit20, Lit31, Lit29, lambda$Fn6);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            runtime.addToCurrentFormEnvironment(Lit34, this.Button3$Click);
        } else {
            addToFormEnvironment(Lit34, this.Button3$Click);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "Button3", "Click");
        } else {
            addToEvents(Lit29, Lit35);
        }
        this.WebViewer1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit36, Lit32, lambda$Fn7), $result);
        } else {
            addToComponents(simpleSymbol, Lit38, Lit32, lambda$Fn8);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            runtime.addToCurrentFormEnvironment(Lit39, this.WebViewer1$BeforePageLoad);
        } else {
            addToFormEnvironment(Lit39, this.WebViewer1$BeforePageLoad);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "WebViewer1", "BeforePageLoad");
        } else {
            addToEvents(Lit32, Lit40);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            runtime.addToCurrentFormEnvironment(Lit47, this.WebViewer1$ErrorOccurred);
        } else {
            addToFormEnvironment(Lit47, this.WebViewer1$ErrorOccurred);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "WebViewer1", "ErrorOccurred");
        } else {
            addToEvents(Lit32, Lit48);
        }
        this.HorizontalArrangement1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit49, Lit50, lambda$Fn9), $result);
        } else {
            addToComponents(simpleSymbol, Lit53, Lit50, lambda$Fn10);
        }
        this.Button1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(Lit50, Lit54, Lit55, lambda$Fn11), $result);
        } else {
            addToComponents(Lit50, Lit56, Lit55, lambda$Fn12);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            addToEvents(Lit55, Lit35);
        }
        this.Button2 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(Lit50, Lit61, Lit62, lambda$Fn13), $result);
        } else {
            addToComponents(Lit50, Lit63, Lit62, lambda$Fn14);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            runtime.addToCurrentFormEnvironment(Lit68, this.Button2$Click);
        } else {
            addToFormEnvironment(Lit68, this.Button2$Click);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "Button2", "Click");
        } else {
            addToEvents(Lit62, Lit35);
        }
        this.Notifier1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit69, Lit44, lambda$Fn15), $result);
        } else {
            addToComponents(simpleSymbol, Lit73, Lit44, lambda$Fn16);
        }
        this.TextToSpeech1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit74, Lit41, Boolean.FALSE), $result);
        } else {
            addToComponents(simpleSymbol, Lit75, Lit41, Boolean.FALSE);
        }
        this.File1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit76, Lit77, Boolean.FALSE), $result);
        } else {
            addToComponents(simpleSymbol, Lit78, Lit77, Boolean.FALSE);
        }
        runtime.initRuntime();
    }
    ...
    static Object lambda3() {
        ...
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit14, "Sonic Channel - Android", simpleSymbol3);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit15, Lit16, Lit17);
        return runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit18, "1.5 (Sky)", simpleSymbol3);
    }
    ...
    static Object lambda4() {
        ...
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit23, Lit24, simpleSymbol3);
        return runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit25, Lit26, simpleSymbol3);
    }
    ...
    static Object lambda6() {
        return runtime.setAndCoerceProperty$Ex(Lit29, Lit30, "Go Home", Lit4);
    }
    ...
    public Object Button3$Click() {
        runtime.setThisForm();
        return runtime.callComponentMethod(Lit32, Lit33, LList.Empty, LList.Empty);
    }

    static Object lambda8() {
        return runtime.setAndCoerceProperty$Ex(Lit32, Lit37, "https://sites.google.com/view/snc-mobile/home", Lit4);
    }
    ...
    public Object WebViewer1$ErrorOccurred(Object $errorCode, Object $description, Object $failingUrl) {
        ...
        runtime.setThisForm();
        runtime.callComponentMethod(Lit41, Lit42, LList.list1("An error has occured"), Lit43);
        return runtime.callComponentMethod(Lit44, Lit45, LList.list1("Page could not load. Please reload app."), Lit46);
    }
    ...
    static Object lambda10() {
        ...
        SimpleSymbol simpleSymbol3 = Lit17;
        runtime.setAndCoerceProperty$Ex(simpleSymbol, simpleSymbol2, intNum, simpleSymbol3);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit23, Lit52, simpleSymbol3);
        return runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit25, Lit26, simpleSymbol3);
    }
    ...
    static Object lambda12() {
        return runtime.setAndCoerceProperty$Ex(Lit55, Lit30, "Clear All Data Stored", Lit4);
    }
    ...
    public Object Button1$Click() {
        runtime.setThisForm();
        SimpleSymbol simpleSymbol = Lit32;
        runtime.callComponentMethod(simpleSymbol, Lit57, LList.Empty, LList.Empty);
        runtime.callComponentMethod(simpleSymbol, Lit58, LList.Empty, LList.Empty);
        return runtime.callComponentMethod(simpleSymbol, Lit59, LList.Empty, LList.Empty);
    }

    static Object lambda14() {
        return runtime.setAndCoerceProperty$Ex(Lit62, Lit30, "Offline View (Save HTML)", Lit4);
    }
    ...
    public Object Button2$Click() {
        runtime.setThisForm();
        runtime.callComponentMethod(Lit32, Lit64, LList.list1("https://drive.usercontent.google.com/u/0/uc?id=1vvdwDJVQP7AHEEPqQmybEIdvQyA0-Kcl&export=download"), Lit65);
        return runtime.callComponentMethod(Lit44, Lit66, LList.list3("The HTML has been downloaded successfully. Locate it in the Files application and access the HTML through your browser from there.", "HTML Downloaded Successfully!", Boolean.TRUE), Lit67);
    }
    ...
    public class frame extends ModuleBody {
        ...
        public Object apply3(ModuleMethod moduleMethod, Object obj, Object obj2, Object obj3) {
            return moduleMethod.selector == 29 ? this.$main.WebViewer1$ErrorOccurred(obj, obj2, obj3) : super.apply3(moduleMethod, obj, obj2, obj3);
        }
